...
SENSOR_ATTR_DEFAULTS: dict[str, dict] = {
    ...
    SensorKey.CPU_COUNT: {CONF_ENTITY_REGISTRY_ENABLED_DEFAULT: False},
    SensorKey.CPU_NAME: {CONF_ENTITY_REGISTRY_ENABLED_DEFAULT: False},
    SensorKey.HARDWARE: {CONF_ENTITY_REGISTRY_ENABLED_DEFAULT: False},
    SensorKey.MODEL: {CONF_ENTITY_REGISTRY_ENABLED_DEFAULT: False},
